class Dcv::Configurators::LindquistBlacklightConfigurator
  ...
  def self.configure(config)
    ...
    config.add_show_field ActiveFedora::SolrService.solr_name('lib_format', :displayable), :label => 'Format', :link_to_search => ActiveFedora::SolrService.solr_name('lib_format', :facetable)
    config.add_show_field ActiveFedora::SolrService.solr_name('lib_collection', :displayable), :label => 'Collection', :link_to_search => ActiveFedora::SolrService.solr_name('lib_collection', :facetable)
