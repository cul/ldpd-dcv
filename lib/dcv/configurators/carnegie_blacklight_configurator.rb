class Dcv::Configurators::CarnegieBlacklightConfigurator
  ...
  def self.configure(config)
    ...
    config.add_show_field ActiveFedora::SolrService.solr_name('origin_info_place', :displayable), label: 'Origin Information', separator_options: COMMA_DELIMITED, helper_method: :display_dateless_origin_info, if: :is_dateless_origin_info?
    config.add_show_field ActiveFedora::SolrService.solr_name('lib_publisher', :displayable), label: 'Publication Information', separator_options: COMMA_DELIMITED, helper_method: :display_publication_info, if: :is_publication_info?
