class Dcv::Configurators::DcvBlacklightConfigurator
  ...
  def self.configure(config)
    ...
    config.add_facet_field ActiveFedora::SolrService.solr_name('lib_collection', :facetable), :label => 'Collection', :limit => 10, :sort => 'count'
    ...
    config.add_show_field ActiveFedora::SolrService.solr_name('rels_int_profile', :stored_searchable)
