class Dcv::Configurators::DcvBlacklightConfigurator
  ...
  def self.configure(config)
    ...
    config.add_facet_field ActiveFedora::SolrService.solr_name('lib_project_short', :symbol), :label => 'Digital Project', :limit => 10
    ...
    config.add_show_field ActiveFedora::SolrService.solr_name('origin_info_place', :displayable, type: :string), :label => 'Place of Origin', :separator => '; '
