...
set :application, 'dlc'
set :repo_url, "git@github.com:cul/ldpd-dcv.git"
  ...
  task :yarn_install do
    on roles(:web) do
      within release_path do
        ...
        execute "bash -c 'source ~/.nvm-alma8/nvm.sh && nvm exec #{fetch(:nvm_node_version)} bash -c \"corepack enable && corepack yarn install --immutable\"'"
