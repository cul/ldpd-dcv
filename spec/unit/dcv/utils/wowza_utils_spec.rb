...
RSpec.describe Dcv::Utils::WowzaUtils do
  ...
  before do
    stub_const('DCV_CONFIG', double('DCV_CONFIG'))
    allow(DCV_CONFIG).to receive(:dig).with(:media_streaming, :wowza).and_return(wowza_config)
