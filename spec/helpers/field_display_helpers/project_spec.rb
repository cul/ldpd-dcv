...
describe FieldDisplayHelpers::Project, :type => :helper do
  ...
  let(:solr_data) {
    {
      id: document_id, field_name => project_title_array
    }
  }
  ...
  describe '#show_field_project_to_facet_link' do
    ...
    let(:project_title_array) { ['Project 1', 'Project 2'] }
    context 'field is linked' do
      ...
      it { is_expected.to satisfy {|x| x[0].include?(">Project 1</a>") && x[1].include?(">Project 2</a>") } }
    end
