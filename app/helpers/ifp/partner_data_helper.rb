module Ifp::PartnerDataHelper
	...
	<p>
	The documents are in English and Portugese Digital materials were received in August 2013 and comprised 2.71 GB of office files, images, presentations, and publications. The paper materials were received in two installments; the first and largest shipment (16.25 l.f.) was received in August 2012, and the other (1.25 l.f.) -  in May 2013. As part of the IFP archiving program, the IFP Brazil website (known as programabolsa) has been harvested semiannually starting in 2012 and until late 2013. 270 Brazilian Fellows gave their consent to open most of their files to researchers in the Reading Room.
	</p>
			",
		},
		chile: {
	...
	The Chile and Peru IFP program closed its operations in 2013. The archive received 12.5 l.f. of paper materials for IFP-Chile in April 2013 and digital materials for Chile and Peru (2.69 GB) was received as a single set of files in June 2013; The materials include administrative program files, fellow files, images, presentations, publications, multimedia, and archived websites in English and Spanish.
		...
		china: {
			...
			:text_excerpt => "Ford Foundation International Fellowships Program in China started in 2001 and selected its last cohort in 2010 with the Beijing Office of the Institute of International Education as its International Partner institution.",
			:text_full => "
	<p>
	...
	263 IFP India Fellows gave their consent to granting researchers access to their files. Digital materials, including program files, mail, and fellow files, and totaling 75.5 GB arrived in July 2013. Paper records, totalling 35 l.f., came in 5 shipments in May-June 2013. The materials are in English.
		...
		indonesia: {
			...
			:text_full => "
		<p>
	The Indonesian International Education Foundation (IIEF) - an Indonesian not-for-profit organization that promotes the development of the Indonesian people through international education served as the IFP International Partner in Indonesia. This organization has been the Indonesian partner organization of the Institute of International Education (IIE) for over thirty years. In 2002-2010, IFP Indonesia selected 365 Fellows from 33 provinces, including people living in remote areas, indigenous people, marginalized communities, or communities located in conflict or post-conflict areas. Upon their return to Indonesia, the IFP program Alumni formed an Alumni organization, Indonesia Social Justice Network (ISJN), whose first founding meeting was held in June 2006 in Jakarta. Its meetings have since been attended by a number of IFP Alumni from India, Vietnam, The Philippines, China, and Thailand. The organization seeks to strengthen the network among ISJN members and any other IFP Alumni associations and to work collaboratively to promote and ensure social justice in their communities.
		</p>
		<p>
	...
	The materials include administrative program files, fellow files and audiovisual materials. 93 Fellows  gave their consent to granting researchers access to their files. The documents are in English and French. Mozambique program had no separate website, and the online activities of its Alumni group can be found on the corresponding page central IFP website, www.fordifp.net.
		...
		nigeria: {
			...
			:text_excerpt => "The Ford Foundation International Fellowships Program in West Africa has been coordinated by the Association of African Universities (AAU) headquartered in Accra, Ghana, the apex organization and forum for consultation, exchange of information and co-operation among institutions of higher education in Africa.",
			:text_full => "
		<p>
	...
	126 Fellows from Uganda, selected in 2001-2010, have enrolled in universities in the United States, Canada, United Kingdom, Australia, continental Europe, Uganda, Kenya and South Africa. AHEAD has also conducted an IFP-funded two year legacy building project for IFP in Uganda, working with Alumni to assist them in consolidating their efforts towards social justice activities that directly affect their communities. AHEAD also works on integrating the lessons learned from IFP into national education agenda.
		...
		<p>
	The Uganda IFP program closed its operations in June 2013. 5 l.f of paper records arrived to the archives in May 2013, and 60 MB of digital materials were received in July 2013.
		</p>
		<p>
