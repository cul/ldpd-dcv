...
class CatalogController < ApplicationController
  ...
  def default_url_option(options)
    # super(options).merge(locale: (I18n.locale if I18n.locale != I18n.default_locale))
    super(options)
  end

  def current_site
    # TODO: Create a Site model
    @current_site ||= Site.new(params[:site_id]) # TODO: Change this to Site.find_by(slug: params[:site_id]) when Site is an ActiveRecord class
  end
  ...
  configure_blacklight do |config|
      ...
      config.default_solr_params = {
        rows: 10,
        qf: "all_text_teim"
        # fq: nil # TODO: Site-specific filter
      }
  ...
  # before_action :configure_blacklight_for_current_site! # , except: [:index, :new, :create]

  # def configure_blacklight_for_current_site!
  #   puts ""
