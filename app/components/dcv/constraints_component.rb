...
module Dcv
  class ConstraintsComponent < Blacklight::ConstraintsComponent
    ...
    def date_range_constraint
      ...
      Blacklight::ConstraintLayoutComponent.new(label: 'Date Range', value: value_, remove_path: remove_path_)
    end
    ...
    def coordinates_constraint
      ...
      Blacklight::ConstraintLayoutComponent.new(label: 'Coordinates', value: value_, remove_path: remove_path_)
    end
    ...
    def durst_constraint
      ...
      Blacklight::ConstraintLayoutComponent.new(label: 'Show', value: "Seymour's Favorites", remove_path: remove_path_)
    end
  end
end