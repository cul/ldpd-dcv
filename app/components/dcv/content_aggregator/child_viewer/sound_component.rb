...
module Dcv::ContentAggregator::ChildViewer
  class SoundComponent < ViewComponent::Base
    include Dcv::Components::ActiveFedoraDocumentBehavior
    include Dcv::Components::ArchiveOrgBehavior

    delegate :poster_url, :render_media_element_streaming_audio_player, to: :helpers
    ...
    def player_options
      ...
      options[:media_type] = 'audio/mp4' unless wowza_media_token_url
      options
    end
