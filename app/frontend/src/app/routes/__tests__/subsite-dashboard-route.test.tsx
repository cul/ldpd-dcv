import { buildSite, buildUser, mockApi, renderApp, screen } from '@/testing/test-utils';
...
describe('Subsite dashboard route', () => {
  beforeEach(() => {
  ...
  describe('when user is admin', () => {
    ...
    it('displays the subsite dashboard', async () => {
      ...
      expect(await screen.findByText(/Welcome to the Subsite Dashboard/i));
    });
  });
