...
const SortableNavGroupFormFields = ({
  ...
  return (
    <Col
      xs={4}
      ref={ref}
      className="rounded p-3 subtle-light-blue-background"
      style={{ margin: 5, maxWidth: 400 }}
    >
      <div>
      ...
      <Row
        ...
        style={{ maxHeight: '75vh', display: isHidden ? 'none' : undefined }}
      >
        <DragDropProvider key={dragProviderKey} onDragEnd={handleDragEnd}>
          ...
          <button type="button" className="btn btn-success" onClick={appendNewLink}>
            Add a link
          </button>
        </DragDropProvider>
      </Row>
