      ...
      <Form onSubmit={handleSubmit(submitHandler)}>
        <Stack gap={3}>
          <Form.Group as={Row} controlId="generalPropertiesFormTitle">
            ...
            <Col xs={10}>
              <Form.Control {...register('title', { disabled: true })} />{' '}
              {/* plaintext readOnly  */}
          ...
          <Form.Group as={Row} controlId="generalPropertiesFormPalette">
            ...
            <Col xs={10}>
              <Form.Select {...register('palette')} aria-label="Select a site palette">
          ...
          <Form.Group as={Row} controlId="generalPropertiesFormLayout">
            ...
            <Col xs={10}>
              <Form.Select {...register('layout')} aria-label="Select a site layout">
          ...
          <Form.Group as={Row} controlId="generalPropertiesFormSearchType">
            <Col xs={2}>
              <div className="d-flex flex-column">
                ...
                <Link to="search-config" className="fs-6 fw-light">
                  Edit facet search config
                </Link>
              </div>
            </Col>
            <Col xs={10}>
              <Form.Select {...register('searchType')} aria-label="Select a search type">
          ...
          <SaveButton isDirty={isDirty} updatedAt={site.updatedAt} isSubmitting={isSubmitting} />
        </Stack>
      </Form>
    </>
  );
