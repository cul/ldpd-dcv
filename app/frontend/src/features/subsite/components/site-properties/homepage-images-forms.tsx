...
const HomepageImagesForms = ({ slug }: { slug: string }) => {
  ...
  return (
    <Container>
      <p>
        If you are using the <span className="fw-bold">Portrait</span> or{' '}
        <span className="fw-bold">Signature</span> Layout types, you can manage the images displayed
        on the site homepage here.
      </p>
      <Accordion defaultActiveKey={`${site.layout}-layout`}>
        <Accordion.Item eventKey="portrait-layout">
          <Accordion.Header>
            <InfoTooltip fieldName="portraitLayoutImages" lookupFn={sitePropertiesTooltipMessage} />
            Portrait Layout Images
          </Accordion.Header>
          <Accordion.Body>
        ...
        <Accordion.Item eventKey="signature-layout">
          <Accordion.Header>
            <InfoTooltip
              fieldName="signatureLayoutImages"
              lookupFn={sitePropertiesTooltipMessage}
            />
            Signature Layout Images
          </Accordion.Header>
          <Accordion.Body>
