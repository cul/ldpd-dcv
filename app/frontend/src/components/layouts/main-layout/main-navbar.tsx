        ...
        <Nav>
          ...
          <Nav.Item>
            {role === ROLES.EDITOR && (
              <NavDropdown title="Your Subsites" id="main-nav-subsites-dropdown" align="end">
                {sites.map((site, i) => (
                  <NavDropdown.Item key={i} as={Link} to={`/sites/${site.slug}`}>
                    {site.title}
                  </NavDropdown.Item>
                ))}
                <NavDropdown.Divider />
                <NavDropdown.Item key={sites.length + 1} as={Link} to="/sites">
                  View all
                </NavDropdown.Item>
              </NavDropdown>
            )}
          ...
          <Nav.Item>
            <NavDropdown title="Help" align="end">
              <NavDropdown.Item onClick={navigatorToRailsRoute('about')}>
                About DLC
              </NavDropdown.Item>
              <NavDropdown.Item href="https://library.columbia.edu/services/askalibrarian.html">
                Ask A Librarian
              </NavDropdown.Item>
              <NavDropdown.Item href="">Suggestions & Feedback (wip)</NavDropdown.Item>
              <NavDropdown.Item href="https://hours.library.columbia.edu">
                Library Hours
              </NavDropdown.Item>
              <NavDropdown.Item href="https://library.columbia.edu/libraries/map.html?location=culis">
                Maps & Locations
              </NavDropdown.Item>
              <NavDropdown.Item href="https://resolver.library.columbia.edu/lweb0208">
                Terms of Use
              </NavDropdown.Item>
            </NavDropdown>
          </Nav.Item>
