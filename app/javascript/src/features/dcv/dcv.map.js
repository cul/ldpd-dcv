...
export const initCulMapDisplayComponent = function($mapComponentDiv) {
	...
	var tiles = L.tileLayer('https://tiles.stadiamaps.com/tiles/alidade_smooth/{z}/{x}/{y}.png', {
	...
	var map = L.map($mapComponentDiv.attr('id'), {
...
export const mapReady = function() {
